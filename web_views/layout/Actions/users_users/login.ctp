...
<div class="col-xs-12 col-sm-6">
    <section class="block">
        ...
        <button onclick="window.location='/users/register'" class="button btn btn-primary"><i class="fa fa-user"></i> <?php ___e('Create an account')?></button>
        <div>&nbsp;</div>
...
<div class="col-xs-12 col-sm-6">
    <section class="block">
        ...
        <button type="submit" class="button btn btn-primary"><i class="fa fa-lock"></i> <?php ___e('Sign in')?></button>
        </form>
    </section>
</div>
