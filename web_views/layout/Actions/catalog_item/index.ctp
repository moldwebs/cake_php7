<div id="ajax_content">
    <h1 class="heading page-heading product-listing">
      <div style="float: left;"><span class="cat-name"><?php e($title_for_action)?><?php if(count($_GET['fltr_eq__extra_2']) == 1) e(' ' . $fltr_manufacturers[$_GET['fltr_eq__extra_2'][0]])?>&nbsp;</span></div>
      <div style="float: right; text-align: right;">
        <span class="hidden-md hidden-lg"><a onclick="$('#switch_left_column').click();" href="javascript:void(0)"><?php ___e('Filters')?></a></span>
      </div>
    ...
    <div class="content_sortPagiBar">
       ...
       <div class="sortPagiBar clearfix">
            <?php echo $this->telement('sort')?>
       </div>
    </div>
    <?php $catalog_view = (empty($tpltoggle['catalog_view']) || $tpltoggle['catalog_view'] == 'grid' ? 'grid row' : 'list')?>
    <?php $catalog_view_li = (empty($tpltoggle['catalog_view']) || $tpltoggle['catalog_view'] == 'grid' ? (1==1 ? 'col-lg-4 col-md-4 col-sm-4 col-xs-6 col-xxs-12': 'col-lg-2 col-md-2 col-sm-3 col-xs-5 col-xxs-12') : 'col-xs-12')?>
    <ul class="product_list <?php e($catalog_view)?> " data-classnames="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-xxs-12" data-default-view=" grid ">
             ...
             <div class="pro_outer_box">
                <div class="pro_first_box ">
                   ...
                   <div class="hover_fly fly_1 clearfix">
                      <a class="_ajax_add_to_cart_button btn btn-default btn_primary" href="/shop/basket/add/<?php e($item['ObjItemList']['id'])?>/0/0" rel="nofollow" title="<?php ___e('Add to cart')?>">
