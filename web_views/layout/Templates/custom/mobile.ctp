...
<ul class="mo_advanced_mu_level_0">
   <?php foreach($menu['links'] as $key => $val):?>
       ...
       <li class="mo_advanced_ml_level_0 mo_advanced_ml_column">
          <?php if($val['data']['url'] == '#'):?>
          <a id="parent_mobile_menu" href="javascript:void(0)" onclick="$(this).next().click();" class="mo_advanced_ma_level_0" title="<?php e($val['title'])?>"><?php e($val['title'])?></a> <span class="opener">&nbsp;</span>
          <?php else:?>
