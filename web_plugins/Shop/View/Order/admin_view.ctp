        ...
        <div class="nw-table">
            ...
            <div class="nw-table-content pd">
                <div class="nw-list">
                    ...
                    <?php $base_fields = array('jur_company' => ___('Company name'), 'jur_adress' => ___('Juridical adress'), 'jur_tax' => ___('VAT code'), 'jur_iban' => ___('IBAN'), 'jur_bank' => ___('Bank'), 'jur_bank_code' => ___('Bank Code'), 'cod_fisc' => ___('Cod Fiscal'), 'post_address' => ___('Adresa Postala'))?>
