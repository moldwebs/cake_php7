        ...
        <div class="nw-table-content pd">
            ...
            <table>
                <thead><tr>
                    ...
                    <th style="width: 150px;"><?php echo $this->Paginator->sort('base_id', ___('Category'));?></th>
                    <th style="width: 150px;"><?php echo $this->Paginator->sort('extra_2', ___('Manufacturer'));?></th>
                    <th style="width: 150px;"><?php echo $this->Paginator->sort('extra_1', ___('Type'));?></th>
