...
class AppModel extends Model {
    ...
    public function delete($id = null, $cascade = true){
        ...
        if($this->alias != 'Session' && $this->nocache != '1' && Configure::read('TMP.sql_no_cache') != '1' && Configure::read('TMP.event_no_cache') != '1' && Configure::read('CMS.no_clear_cache') != '1') Cache::clearGroup('query');
        return $return;
    }
    ...
    public function save($data = null, $validate = true, $fieldList = array()) {
        ...
        if($this->alias != 'Session' && $this->nocache != '1' && Configure::read('TMP.sql_no_cache') != '1' && Configure::read('TMP.event_no_cache') != '1' && Configure::read('CMS.no_clear_cache') != '1'){
