        ...
        <div class="nw-table-content">
            <div class="tabs-left">
                ...
                <div id="node-1">
                    ...
                    <?php echo $this->Layout->__input('desc', array('label' => ___('Description')));?>
                    <?php echo $this->Form->input('ObjItemTree.data.type', array('options' => Configure::read('CMS.mod_blocks'), 'label' => ___('Contain'), 'empty' => ___('Select...'), 'class' => 'req'));?>
                    <div id="contain_box">
                        <div id="box_script">
...
<script>
    $('#ObjItemTreeDataBlockTemplate').on('change', function(){
        if($(this).val() == '1'){
            $('#ObjItemTreeDataBlockTemplateHeader').parent().show();
            $('#ObjItemTreeDataCustomBlockTemplate').parent().show();
        } else {
            $('#ObjItemTreeDataBlockTemplateHeader').parent().hide();
            $('#ObjItemTreeDataCustomBlockTemplate').parent().hide();
        }
    }).trigger('change');
    /*
