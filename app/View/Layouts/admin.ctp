...
<head>
    ...
    <script type="text/javascript" src="/plugins/jquery-ui/jquery.multiselect.js"></script>
    <link rel="stylesheet" type="text/css" href="/plugins/jquery-ui/jquery.multiselect.css" />
